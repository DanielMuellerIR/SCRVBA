...
Begin Form
    ...
    RecSrcDt = Begin
        0xf161585a37cce440
    End
    RecordSource ="Filter_für_Buchungen_suchen"
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT Sachbearbeiter.ID, Sachbearbeiter.Name, Sachbearbeiter.Telefon FROM Sachb"
                        "earbeiter WHERE (((Sachbearbeiter.Buchungsverantwortlicher)=True)) ORDER BY Sach"
                        "bearbeiter.Name;"
...
End
CodeBehindForm
' See "Buchungsanordnung_Suche.cls"
