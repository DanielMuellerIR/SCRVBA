...
Begin Report
    ...
    Left =11385
    Top =2415
    Filter ="([Bewertung_Archiv_4].[Erläuterung]=\"Test Budde 24.08.2016\"\"\")"
    RecSrcDt = Begin
        0xb9a36125cfcde440
    End
    RecordSource ="B_Archivierung_Gebäudebewertung_4_lesen"
...
End
CodeBehindForm
' See "Gebäudebewertung_Archiv_Unterbericht_Werterhöhung.cls"
