...
Begin Report
    ...
    Left =7920
    Top =2460
    Filter ="([Bewertung_Archiv_2].[Erläuterung]=\"Test Budde 24.08.2016\")"
    RecSrcDt = Begin
        0xa2222611cfcde440
    End
    RecordSource ="B_Archivierung_Gebäudebewertung_2_lesen"
...
End
CodeBehindForm
' See "Gebäudebewertung_Archiv_Unterbericht_Ausstattung.cls"
