...
Begin Report
    ...
    RecSrcDt = Begin
        0xc98eb4aed0e1e440
    End
    RecordSource ="SELECT tbl_200_30_20_Bew_Bilanz_Werterhoehungen.* FROM tbl_200_30_20_Bew_Bilanz_"
        "Werterhoehungen WHERE (((tbl_200_30_20_Bew_Bilanz_Werterhoehungen.ID_Bew_Bil)=F_"
        "Variable(\"lng_ID_Bew_Bil\")));"
...
End
CodeBehindForm
' See "Gebäudebewertung_Unterbericht_Werterhöhung.cls"
