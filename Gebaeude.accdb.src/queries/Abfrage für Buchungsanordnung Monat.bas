Operation =1
Option =0
Where ="(((A_Buchungen.ID)=[Formulare]![Monatsanordnung_UF_5]![IDneu]))"
Begin InputTables
    Name ="A_Buchungen"
...
Begin OutputColumns
    ...
    Alias ="Zahlung"
    Expression ="[Formulare]![Monatsanordnung]![Zahlung]"
    Alias ="Auftragsnummer"
    Expression ="[Formulare]![Monatsanordnung]![Auftragsnummer]"
