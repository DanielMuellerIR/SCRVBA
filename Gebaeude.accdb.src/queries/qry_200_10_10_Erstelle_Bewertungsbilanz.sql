...
FROM
  qry_200_05_10_Fehlende_Erstbewertungen
  RIGHT JOIN (
  ...
  ) ON qry_200_05_10_Fehlende_Erstbewertungen.ID_Gebäudeteil = B_Abfrage_für_Formular.ID_Gebäudeteil
WHERE
  (
    (
      (
    ...
    AND (
      (
        qry_200_05_10_Fehlende_Erstbewertungen.Status
      )<> "Erstbil. zum Geb.teil fehlt"
      Or (
        qry_200_05_10_Fehlende_Erstbewertungen.Status
      ) Is Null
    )
