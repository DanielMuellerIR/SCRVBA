Operation =1
Option =0
Where ="(((tbl_100_20_Gebäudeteile.Baujahr_real)>#12/31/1999#) AND ((tbl_100_20_Gebäudet"
    "eile.Neubauwert_ab_2000) Is Null) AND ((tbl_100_20_Gebäudeteile.ID_GebT_Zug_GebT"
    ") Is Null))"
Begin InputTables
...
Begin OutputColumns
    ...
    Alias ="Fehler"
    Expression ="\"06 : Reale Herstellungskosten ab BJ. 2000 fehlen\""
End
Begin Joins
