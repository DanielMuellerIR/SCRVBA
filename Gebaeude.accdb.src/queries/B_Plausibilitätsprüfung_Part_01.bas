Operation =1
Option =0
Where ="(((tbl_050_10_Gemarkungen.Gemarkung) Is Null)) OR (((tbl_070_10_Flure.Flur) Is N"
    "ull)) OR (((fc_Flurstuecke([tbl_100_10_Liegenschaften].[ID_Gebäude]))=\"\"))"
Begin InputTables
...
Begin OutputColumns
    ...
    Alias ="Fehler"
    Expression ="\"01 : zur Liegenschaft unvollständige Katasterdaten \""
End
Begin Joins
