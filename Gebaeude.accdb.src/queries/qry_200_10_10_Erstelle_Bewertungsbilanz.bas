...
Option =0
Where ="(((B_Abfrage_für_Formular.ID_Gebäudeteil) Between F_VAriable(\"lng_ID_Geb_Teil_M"
    "in\") And F_VAriable(\"lng_ID_Geb_Teil_Max\")) AND ((B_Abfrage_für_Formular.ID_G"
    "ebT_Zug_GebT) Is Null) AND ((B_Abfrage_für_Formular.Bilanz_relevant)=True) AND ("
    "(qry_200_05_10_Fehlende_Erstbewertungen.Status)<>\"Erstbil. zum Geb.teil fehlt\""
    " Or (qry_200_05_10_Fehlende_Erstbewertungen.Status) Is Null))"
Begin InputTables
    Name ="B_Abfrage_für_Formular"
    Name ="B_Abfrage_für_Bericht_0"
    Name ="qry_200_05_10_Fehlende_Erstbewertungen"
End
Begin OutputColumns
    Alias ="idbew"
    Name ="Id_Bewert"
...
Begin Joins
    ...
    Flag =2
    LeftTable ="qry_200_05_10_Fehlende_Erstbewertungen"
    RightTable ="B_Abfrage_für_Formular"
    Expression ="qry_200_05_10_Fehlende_Erstbewertungen.ID_Gebäudeteil = B_Abfrage_für_Formular.I"
        "D_Gebäudeteil"
    Flag =3
End
Begin OrderBy
