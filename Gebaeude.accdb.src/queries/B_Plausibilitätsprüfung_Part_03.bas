Operation =1
Option =0
Where ="(((tbl_100_20_Gebäudeteile.Baujahr_real)=0 Or (tbl_100_20_Gebäudeteile.Baujahr_r"
    "eal) Is Null) AND ((tbl_100_20_Gebäudeteile.ID_GebT_Zug_GebT) Is Null))"
Begin InputTables
...
Begin OutputColumns
    ...
    Alias ="Fehler"
    Expression ="\"03 : zum Gebäudeteil fehlendes Baujahr\""
End
Begin Joins
