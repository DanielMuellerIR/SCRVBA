Operation =1
Option =0
Where ="(((tbl_100_20_Gebäudeteile.[Typ aus NHK-Typen])=0 Or (tbl_100_20_Gebäudeteile.[T"
    "yp aus NHK-Typen]) Is Null) AND ((tbl_100_20_Gebäudeteile.ID_GebT_Zug_GebT) Is N"
    "ull) AND ((tbl_100_20_Gebäudeteile.Baujahr_real)<#1/1/2000#))"
Begin InputTables
...
Begin OutputColumns
    ...
    Alias ="Fehler"
    Expression ="\"02 : zum Gebäudeteil fehlt der  NHK-Typ\""
End
Begin Joins
