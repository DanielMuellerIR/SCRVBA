Operation =1
Option =0
Where ="(((Maßnahmen.ID) Like [Formulare]![Filter für Arbeitsprogramm erweitert]![Massna"
    "hme]) AND ((Haushaltsdaten.[ID aus Maßnahmen]) Is Not Null) AND ((Maßnahmen.Bear"
    "beiter) Like [Formulare]![Filter für Arbeitsprogramm erweitert]![Bearbeiter]) AN"
    "D ((Maßnahmen.[erledigt im Jahr]) Is Null) AND (([Gebäudeliste].[Bezeichung]+[St"
    "raße Hausnummer]) Like [Formulare]![Filter für Arbeitsprogramm erweitert]![Gebäu"
    "de]))"
Begin InputTables
    Name ="Sachbearbeiter"
    Name ="Gebäudeliste"
...
Begin OutputColumns
    ...
    Alias ="Gebäude"
    Expression ="[Straße Hausnummer] & \",  \" & [Bezeichung]"
