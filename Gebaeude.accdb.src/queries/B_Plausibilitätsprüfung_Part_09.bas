Operation =1
Option =0
Having ="(((Sum(Zuordnung_Abschreibung.Anteil))<>1 Or (Sum(Zuordnung_Abschreibung.Anteil)"
    ") Is Null))"
Begin InputTables
...
Begin OutputColumns
    ...
    Alias ="Fehler"
    Expression ="\"09 : Abschreibungsanteile zu Gebäudeteilen fehlen oder ergeben nicht 100%\""
End
Begin Joins
