...
SELECT
  ...
  [Euro je BGF] * [tbl_100_20_Gebäudeteile].[BGF] AS Wert1,
  ...
  [formulare]![startformular]![bewertungsjahr] AS Bewertungsjahr,
  [formulare]![startformular]![Index ab 2000] AS [index ab 2000],
...
FROM
  (
    ...
    LEFT JOIN tbl_100_20_Gebäudeteile ON B_Abfrage_für_Formular.ID_Gebäudeteil = tbl_100_20_Gebäudeteile.ID_Gebäudeteil
  )
