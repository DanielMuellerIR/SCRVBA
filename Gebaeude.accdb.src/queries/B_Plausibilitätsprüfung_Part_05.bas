Operation =1
Option =0
Where ="(((tbl_100_20_Gebäudeteile.[Bewertung abgeschlossen]) Is Null) AND ((tbl_100_20_"
    "Gebäudeteile.ID_GebT_Zug_GebT) Is Null))"
Begin InputTables
...
Begin OutputColumns
    ...
    Alias ="Fehler"
    Expression ="\"05 : zum Gebäudeteil ist Bewertung noch nicht abgeschlossen\""
End
Begin Joins
