...
Begin InputTables
    ...
    Name ="qry_HK_Aus_B_Sanierungsstau"
End
Begin OutputColumns
    ...
    Alias ="Herstellkosten_berechnet_alt"
    ...
    Alias ="WBW_Neu"
    Expression ="CDbl(WBW_Berechnen_2022([qry_rpt_200_10_10_Datenherk_Bewertungsbilanz].[ID_Gebäu"
        "deteil]))"
    Alias ="Herstellkosten_neu"
    Expression ="CDbl(HK_fuer_GebTeil_2022([qry_rpt_200_10_10_Datenherk_Bewertungsbilanz].[ID_Geb"
        "äudeteil]))"
    Expression ="qry_HK_Aus_B_Sanierungsstau.Herstellkosten"
End
Begin Joins
    ...
    Expression ="qry_rpt_200_10_10_Datenherk_Bewertungsbilanz.id_Bewert = tbl_200_05_10_Bewertung"
        "släufe.id_Bewert"
    Flag =1
    LeftTable ="qry_HK_Aus_B_Sanierungsstau"
    RightTable ="qry_rpt_200_10_10_Datenherk_Bewertungsbilanz"
    Expression ="qry_HK_Aus_B_Sanierungsstau.ID_Gebäudeteil = qry_rpt_200_10_10_Datenherk_Bewertu"
        "ngsbilanz.ID_Gebäudeteil"
    Flag =1
End
Begin OrderBy
    Expression ="[Straße] & \": \" & [qry_rpt_200_10_10_Datenherk_Bewertungsbilanz].[Bezeichnung]"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="Herstellkosten_berechnet_alt"
        dbInteger "ColumnWidth" ="1785"
        dbBoolean "ColumnHidden" ="0"
        dbText "Format" ="#,##0.00 €;-#,##0.00 €"
        dbLong "AggregateType" ="-1"
    ...
    End
    Begin
        dbText "Name" ="Herstellkosten_neu"
        dbInteger "ColumnWidth" ="1785"
        dbBoolean "ColumnHidden" ="0"
        dbText "Format" ="#,##0.00 €;-#,##0.00 €"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="qry_HK_Aus_B_Sanierungsstau.Herstellkosten"
        dbLong "AggregateType" ="-1"
    End
End
Begin
