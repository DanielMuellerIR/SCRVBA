        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    LayoutCachedWidth =14641
                    LayoutCachedHeight =5081
                    ThemeFontIndex =-1
                    ForeTint =100.0
                    Begin
                        Begin Label
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT tbl_20_20_Vergabe_Art.ID_Vergabe_Art, [Vergabe_Grundlage] & \" (\" & [Ver"
                ...
                Begin ComboBox
                    ...
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT tbl_10_30_Objekte.ID_Obj, tbl_10_30_Objekte.Objekt FROM tbl_10_30_Objekte"
                        " WHERE (((tbl_10_30_Objekte.Nutzungsende) Is Null)) ORDER BY tbl_10_30_Objekte.O"
                        "bjekt; "
                    ColumnWidths ="0"
                    AfterUpdate ="=Aktual_F_Listenfeld()"
                    FontName ="Arial"
                ...
                Begin ComboBox
                    ...
                    ControlSource ="ID_Fa"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT tbl_10_40_Firmen.ID_Fa, tbl_10_40_Firmen.Name, tbl_10_40_Firmen.Ort, tbl_"
                        "10_40_Firmen.Straße FROM tbl_10_40_Firmen WHERE (((tbl_10_40_Firmen.Ab_Datum_Kei"
                        "n_Auftrag)>Date() Or (tbl_10_40_Firmen.Ab_Datum_Kein_Auftrag) Is Null)) ORDER BY"
                        " tbl_10_40_Firmen.Name, tbl_10_40_Firmen.Ort, tbl_10_40_Firmen.Straße; "
                    ColumnWidths ="0;4536"
                    AfterUpdate ="=Aktual_F_Listenfeld()"
                    FontName ="Arial"
                    GridlineColor =10921638
...
End
CodeBehindForm
' See "frm_20_20_Auftrgasdaten_EDS.cls"
