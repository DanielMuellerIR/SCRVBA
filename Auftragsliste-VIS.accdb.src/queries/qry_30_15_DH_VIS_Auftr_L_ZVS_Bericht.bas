dbMemo "SQL" ="SELECT tbl_20_10_Aufträge.*, Mid([tbl_20_10_Aufträge].[Auftragsnr],4,4) AS Jahr,"
    ...
    "\012WHERE (((Mid(tbl_20_10_Aufträge.Auftragsnr,4,4))=Formulare!frm_10_10_Startfo"
    "rmular!TF_Filter_Jahr) And ((tbl_20_10_Aufträge.Schätzkosten) Between 250 And 15"
    "000))\015\012ORDER BY Right([tbl_20_10_Aufträge].[Auftragsnr],4);\015\012"
dbMemo "Connect" =""
