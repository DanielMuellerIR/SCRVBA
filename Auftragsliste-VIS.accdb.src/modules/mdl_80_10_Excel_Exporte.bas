Attribute VB_Name = "mdl_80_10_Excel_Exporte"
...
60  str_Spalte = Chr(64 + CurrentDb.QueryDefs(Abfr_Name).Fields.Count)
...
140     i = i + 1
150     xl.Columns(Chr(64 + i)).Select
...
390 xl.Rows("1:" & str_Zeile).EntireRow.AutoFit

    ' Füge oben drüber 5 Leerzeilen ein
400 xl.Rows("1").Select
410 For i = 1 To 5
420     xl.Rows(1).Insert
430 Next i

    ' Gehe zur Zelle A2 und trage Überschriftshinweis ein
440 xl.Range("A2").Select
450 xl.ActiveCell.FormulaR1C1 = Hinweis
460 xl.Selection.HorizontalAlignment = xlLeft
